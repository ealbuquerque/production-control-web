...
export const PATH_TO_GO_BACK = '/products';

export const createProduct = history => data => (dispatch) => {
  const dispatcher = `${CONTEXT}.createProduct`;
...
export const updateProduct = (history, id) => data => (dispatch) => {
  const dispatcher = `${CONTEXT}.updateProduct`;
  dispatch(loadingShowAction(dispatcher));
